...
public class orders_Loader {
    ...
    private static String contractLoader =
            "insert into contract(contract_number,contract_date,client_enterprise)"
                    +" values(?,?,?,?)";
    ...
    private static String ordersLoader =
            "insert into orders2(contract_number,product_model,quantity,estimated_delivery_date,lodgement_date,salesman_number)"
                    +" values(?,?,?,?,?,?)";
    ...
    private static void openDB(String host, String dbname,
        ...
        try {
            stmt = con.prepareStatement(ordersLoader);
        } catch (SQLException e) {
    ...
    private static void loadData(String contract_number,String product_model,int quantity ,String estimated_delivery_date,String lodgement_date,int salesman_number)
            throws SQLException {
        if (con != null) {
            stmt.setString(1, contract_number);
            stmt.setString(2, product_model);
            stmt.setInt(3, quantity);
            stmt.setString(4, estimated_delivery_date);
            stmt.setString(5, lodgement_date);
            stmt.setInt(6, salesman_number);
            stmt.addBatch();
        }
    }
        ...
        try (BufferedReader infile
            ...
            while ((line = infile.readLine()) != null) {
                ...
                if (parts.length > 1) {
                        ...
                        loadData(contract_number,product_model,quantity,estimated_delivery_date,lodgement_date,salesman_number);
                        cnt++;
